...
public class TravelFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.vehicle:
                i = new Intent(activity, SelectModeOfTransportActivity.class);
                startActivity(i);
                break;

            case R.id.shopping:
                i = new Intent(activity, ShoppingCurrentCityActivity.class);
                startActivity(i);
                break;

            case R.id.accomo:
                i = new Intent(activity, HotelsActivity.class);
                startActivity(i);
                break;
            ...
            case R.id.mytrips:
                i = new Intent(activity, MyTripsActivity.class);
                startActivity(i);
                break;
        }
    }
