...
class MyTripsAdapter extends ArrayAdapter<Trip> {
    ...
    static  int ADDNEWTRIP_ACTIVITY_RESPONSE=203;
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            view.setOnClickListener(v -> {
                ...
                originActivity.startActivityForResult(new Intent(mContext, AddNewTripActivity.class),ADDNEWTRIP_ACTIVITY_RESPONSE );
            });
