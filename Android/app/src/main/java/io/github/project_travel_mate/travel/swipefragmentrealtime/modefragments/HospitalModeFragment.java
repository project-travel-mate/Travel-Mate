...
public class HospitalModeFragment extends Fragment {
    ...
    public static HospitalModeFragment newInstance(String currentLat, String currentLon) {
        mCurlat = currentLat;
        mCurlon = currentLon;
    ...
    private void getPlaces() {
        ...
        String uri = HERE_API_LINK + "?at=" + mCurlat + "," + mCurlon + "&cat=" + HERE_API_MODES.get(7)
