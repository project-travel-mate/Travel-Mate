...
public class WorldClockActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAnalogClock.init(WorldClockActivity.this, R.drawable.clockface,
                R.drawable.hour_hand, R.drawable.minute_hand,
                0, false, false);

        mAnalogClock.setAutoUpdate(false);
    ...
    private String getSavedValue(String key) {
        ...
        return PreferenceManager.getDefaultSharedPreferences(getBaseContext())
                .getString(key, getString(R.string.time_zone));
    }
