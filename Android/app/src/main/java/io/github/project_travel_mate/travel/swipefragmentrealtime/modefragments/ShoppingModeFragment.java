...
public class ShoppingModeFragment extends Fragment {
    ...
    public static ShoppingModeFragment newInstance(String currentLat, String currentLon) {
        mCurlat = currentLat;
        mCurlon = currentLon;
    ...
    private void getPlaces() {
        ...
        String uri = HERE_API_LINK + "?at=" + mCurlat + "," + mCurlon + "&cat=" + HERE_API_MODES.get(4)
