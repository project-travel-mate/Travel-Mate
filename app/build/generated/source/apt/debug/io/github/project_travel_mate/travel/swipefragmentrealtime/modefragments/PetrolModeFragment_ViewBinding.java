...
public class PetrolModeFragment_ViewBinding implements Unbinder {
  private PetrolModeFragment target;

  @UiThread
  public PetrolModeFragment_ViewBinding(PetrolModeFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PetrolModeFragment target = this.target;
