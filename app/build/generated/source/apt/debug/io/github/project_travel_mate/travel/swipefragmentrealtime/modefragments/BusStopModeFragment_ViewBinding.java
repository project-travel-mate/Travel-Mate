...
public class BusStopModeFragment_ViewBinding implements Unbinder {
  private BusStopModeFragment target;

  @UiThread
  public BusStopModeFragment_ViewBinding(BusStopModeFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    BusStopModeFragment target = this.target;
