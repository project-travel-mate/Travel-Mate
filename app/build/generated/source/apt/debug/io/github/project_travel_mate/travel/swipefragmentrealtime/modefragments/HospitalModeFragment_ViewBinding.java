...
public class HospitalModeFragment_ViewBinding implements Unbinder {
  private HospitalModeFragment target;

  @UiThread
  public HospitalModeFragment_ViewBinding(HospitalModeFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    HospitalModeFragment target = this.target;
