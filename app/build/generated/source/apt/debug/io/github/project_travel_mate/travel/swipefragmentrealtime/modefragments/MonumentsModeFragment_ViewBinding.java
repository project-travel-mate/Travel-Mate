...
public class MonumentsModeFragment_ViewBinding implements Unbinder {
  private MonumentsModeFragment target;

  @UiThread
  public MonumentsModeFragment_ViewBinding(MonumentsModeFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MonumentsModeFragment target = this.target;
